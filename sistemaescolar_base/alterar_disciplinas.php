...
<div class="container lista">
        ...
        <div class="row">
        <div class="col-lg-12">
            <form action="alterar_disciplinas.php?numero=<?php echo $dadosDisciplina->numero; ?>" method="post">
                    <div class="row">
                        <div class="form-group col-lg-9">
                            <label for="numero">Numero</label>
                            <input type="number" name="numero" class="form-control" value="<?php echo $dadosDisciplina->numero; ?>" >
                        </div>
                        <div class="form-group col-lg-9">
