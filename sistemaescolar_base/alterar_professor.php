            ...
            <form action="alterar_professor.php?numero=<?php echo $dadosProfessor->numero; ?>" method="post">
                    <div class="row">
                        <div class="form-group col-lg-9">
                            ...
                            <input type="number" name="numero" class="form-control" value="<?php echo $dadosProfessor->numero; ?>" >
                        </div>
                        <div class="form-group col-lg-9">
                    ...
                    <div align="center">
                        ...
                        <a class="btn btn-outline-danger" href="index_professores.php.php">Cancelar</a>
                    </div>
            </form>
        </div>
    </div>
